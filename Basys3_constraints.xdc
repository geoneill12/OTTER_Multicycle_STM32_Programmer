...
set_property PACKAGE_PIN A14 [get_ports {JB[0]}]	
    set_property PULLDOWN TRUE [get_ports {JB[0]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {JB[0]}]
#Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports {JB[1]}]
    set_property PULLDOWN TRUE [get_ports {JB[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {JB[1]}]
#Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports {JB[2]}]	
    set_property PULLDOWN TRUE [get_ports {JB[2]}]				
...
set_property PACKAGE_PIN A15 [get_ports {JB[4]}]	
    set_property PULLDOWN TRUE [get_ports {JB[4]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {JB[4]}]
#Sch name = JB8
set_property PACKAGE_PIN A17 [get_ports {JB[5]}]	
    set_property PULLDOWN TRUE [get_ports {JB[5]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {JB[5]}]
#Sch name = JB9
set_property PACKAGE_PIN C15 [get_ports {JB[6]}]	
    set_property PULLDOWN TRUE [get_ports {JB[6]}]				
...
set_property PACKAGE_PIN K17 [get_ports {JC[0]}]			
    set_property PULLDOWN TRUE [get_ports {JC[0]}]		
	set_property IOSTANDARD LVCMOS33 [get_ports {JC[0]}]
#Sch name = JC2
set_property PACKAGE_PIN M18 [get_ports {JC[1]}]				
    set_property PULLDOWN TRUE [get_ports {JC[1]}]	
	set_property IOSTANDARD LVCMOS33 [get_ports {JC[1]}]
#Sch name = JC3
#set_property PACKAGE_PIN N17 [get_ports {JC[2]}]					
#    set_property PULLDOWN TRUE [get_ports {JC[2]}]
...
#    set_property PULLDOWN TRUE [get_ports {JC[4]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {JC[4]}]
##Sch name = JC8
#set_property PACKAGE_PIN M19 [get_ports {JC[5]}]					
#    set_property PULLDOWN TRUE [get_ports {JC[5]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {JC[5]}]
##Sch name = JC9
#set_property PACKAGE_PIN P17 [get_ports {JC[6]}]					
#    set_property PULLDOWN TRUE [get_ports {JC[6]}]
...
#set_property PACKAGE_PIN A18 [get_ports TRX]						
#	set_property IOSTANDARD LVCMOS33 [get_ports TRX]
